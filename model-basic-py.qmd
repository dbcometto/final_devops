...
**The finished model can be accessed [here](http://{{< var apphost >}}:8090){target="_blank"}**.  It runs on a background API and a ShinyApp.  However, let's dive into how the model is created.
